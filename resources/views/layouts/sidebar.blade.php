<div class="drawer-side">
    ...
    <ul class="menu p-4 overflow-y-auto w-80 bg-white text-base-content">
        ...
        <li><a class="{{ Route::currentRouteName() == 'banner' ? 'active' : '' }}" href="{{ route('banner') }}">Banner</a>
        </li>
        ...
        <li><a class="{{ Route::currentRouteName() == 'view.order' ? 'active' : '' }}"
                href="{{ route('view.order') }}">View Orders</a></li>
    </ul>
</div>
