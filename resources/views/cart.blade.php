...
@section('content')
    <section class="h-screen bg-gray-100 py-12 sm:py-16 lg:py-20">
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mx-auto mt-8 max-w-3xl md:mt-12">
                    ...
                    <div class="px-4 py-6 sm:px-8 sm:py-10">
                                    ...
                                    <li class="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                                        <div class="shrink-0 mr-5">
                                            <img class="h-24 w-24 max-w-full rounded-lg object-cover"
                                                src="{{ asset('uploads/products/Cain_Pittman_2.jpg') }}" alt="" />
                                        </div>
                                                    ...
                                                    <div class="sm:order-1">
                                                        <div class="mx-auto flex h-8 items-stretch text-gray-600">
                                                            ...
                                                            <input type="text" readonly
                                                                class="text-center w-full bg-gray-100 px-4 text-xs uppercase transition"
                                                                name="" value="1" id="product_quantity">
                                                            <button id="product_increment"
                        ...
                        <div class="mt-6 flex items-center justify-between">
                            ...
                            <p class="text-2xl font-semibold text-gray-900"><span
                                    class="text-xs font-normal text-gray-400">USD</span> 408.00</p>
                        </div>
